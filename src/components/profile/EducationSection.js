    ...
    <section className="group">
      ...
      <div className="relative">
        ...
        <div className="absolute left-6 top-0 bottom-0 w-0.5 hidden md:block overflow-hidden">
          <div className="w-full h-full bg-gradient-to-b from-amber-500 via-orange-500 to-amber-500/20 timeline-line-animated"></div>
        </div>
          ...
          {education.map((edu, index) => (
            ...
            >
              <div className="relative md:pl-16 group/item">
                {/* Timeline dot */}
                <div className="absolute left-4 top-8 w-5 h-5 bg-slate-950 border-4 border-amber-500 rounded-full shadow-lg shadow-amber-500/20 hidden md:flex items-center justify-center group-hover/item:scale-125 transition-transform duration-300 dot-pulse" style={{ '--delay': `${index * 150}ms` }}>
