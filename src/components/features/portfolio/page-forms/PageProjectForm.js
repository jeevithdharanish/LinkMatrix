...
import { faPlus, faSave, faTrash, faFolderOpen } from "@fortawesome/free-solid-svg-icons";
...
export default function PageProjectForm({ page, initialProjects }) {
  ...
  return (
    <SectionBox>
      <form onSubmit={save}>
        <FormHeader title="Projects" description="Showcase your recent projects, applications, and source repositories" icon={faFolderOpen} />
        ...
        <div className="space-y-3">
          ...
          {items.map((item) => (
            <div key={item._id} className="p-4 bg-gray-50/50 dark:bg-slate-800/40 rounded-xl border border-gray-200 dark:border-slate-700/80 hover:border-indigo-200 dark:hover:border-indigo-500/50 transition-all duration-200">
              <div className="mb-3">
                <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">Project Title</label>
                <input
                  value={item.title}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">Tech Stack</label>
                  <input
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">Duration</label>
                  <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">GitHub Link <span className="text-gray-400 dark:text-slate-500 font-normal normal-case">(optional)</span></label>
                  <input
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">Live Demo Link <span className="text-gray-400 dark:text-slate-500 font-normal normal-case">(optional)</span></label>
                  <input
                    value={item.liveLink}
              ...
              <div className="mb-2">
                <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1 uppercase tracking-wider">Summary / Description</label>
                <textarea
                  value={item.summary}
