      ...
      <form action={save}>
        ...
        <div>
          <ReactSortable
            ...
            {links.map(l => (
              <div key={l.key} className="mt-3 md:flex gap-5 items-center p-4 border border-gray-200 dark:border-slate-700 rounded-xl hover:border-indigo-200 dark:hover:border-indigo-500/50 transition-all duration-200 bg-gray-50/50 dark:bg-slate-850/50">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 space-y-1.5">
                    <input
                      ...
                      type="file"
                      className="hidden" />
                    <label htmlFor={'icon' + l.key} className="border border-gray-200 dark:border-slate-700 p-1.5 flex items-center gap-1 text-gray-500 dark:text-slate-400 cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-slate-750 hover:border-gray-300 dark:hover:border-slate-600 transition duration-150 text-xs justify-center">
                      <FontAwesomeIcon icon={faCloudArrowUp} className="text-indigo-500" />
                      <span>Icon</span>
                    </label>
                    <button
                      onClick={() => removeLink(l.key)}
                      type="button" className="w-full bg-red-50 dark:bg-red-950/20 text-red-500 dark:text-red-400 py-1.5 px-2 flex gap-1 items-center justify-center rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 dark:hover:bg-red-900/40 transition duration-200 text-xs">
                ...
                <div className="grow space-y-2 mt-3 md:mt-0">
                  <div>
                    ...
                    <input
                      ...
                      type="text" placeholder="Title" className="border border-gray-200 dark:border-slate-700 rounded-xl p-2.5 w-full text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all" />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      type="text" placeholder="Subtitle (optional)" className="border border-gray-200 dark:border-slate-700 rounded-xl p-2.5 w-full text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all" />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      type="text" placeholder="https://..." className="border border-gray-200 dark:border-slate-700 rounded-xl p-2.5 w-full text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all" />
                  </div>
                </div>
              </div>
            ))}
